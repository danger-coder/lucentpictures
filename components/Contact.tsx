    ...
    return (
        <div className='relative'>
            ...
            <div className='absolute top-0 right-0 border text-white p-[20px] bg-white/10 md:p-[25px]'>
                ...
                <h2 className='text-[19px] leading-[23px] font-medium md:text-[22px] md:leading-[26px] xl:text-[24px]'>Contact Us</h2>
                <div className='h-[1px] w-full bg-white my-[12.8px]'></div>
                <div className='text-[13px] leading-[19px] font-normal md:text-[14px] md:leading-[22px] xl:text-[16px]'>
                    <p>Lucent Pictures</p>
                    <p>324 Tusal Marg</p>
                    <p>Kathmandu 7</p>
                    <p>Nepal</p>
